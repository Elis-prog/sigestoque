      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Visualizar Produtos</li>
          </ol>
        </nav>
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <a href="add_prod.php" class="btn btn-dark">
              ...
              <?php include('message2.php') ?>
                <thead class="thead-light">
                  ...
                  <th scope="col">ID.</th>
                    ...
                    <th scope="col">Preço(KZS)</th>
                    <th scope="col">Acção</th>
                  </tr>
                </thead>
                <tbody>
                  <?php
                  $ret = "SELECT * from tblproduto p inner join tblfornecedor f on f.idFor=p.idFor ";
                  ...
                  ?>
                    ...
                    <td><?php echo $prod->idPro; ?></td>
                      ...
                      <form action="superadmin.php" method="POST" onsubmit="return confirm('Tens a certeza de que pretende eliminar este registo?');" style="display:inline;">
                          <input type="hidden" name="delete_id" value="<?php echo $prod->idPro; ?>">
                          <button type="submit" name="deletedataprod" class="btn btn-sm btn-danger">
                            <i class="fas fa-trash"></i> Excluir
                          </button>
                      </form>
                        <a href="update_prod.php?update=<?php echo $prod->idPro; ?>">
